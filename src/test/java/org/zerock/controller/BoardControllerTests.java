...
public class BoardControllerTests {
	...
	// server을 실행시키지 않고도 dispatcherServelet에 요청을 날리려고
	...
	public void testRegister() throws Exception {
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/board/register").param("title", "테스트 새글 제목")
				.param("content", "테스트 새글 내용").param("writer", "user00")).andReturn();
	...
	public void testModify() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", key + "")
						.param("title", "수정된 게시물111").param("content", "수정된 본문11111").param("writer", "user00"))
				.andReturn();
		FlashMap map = result.getFlashMap();
		String viewName = result.getModelAndView().getViewName();
		...
		assertEquals("수정된 본문11111", mod.getContent());
	...
	public void testRemove() throws Exception {
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", key + ""))
				.andReturn();
	...
	public void testListPaging() throws Exception {
		MvcResult result = mockMvc
				.perform(MockMvcRequestBuilders.get("/board/list").param("pageNum", "2").param("amount", "10"))
				.andReturn();
